...
implements WorkflowController {
	...
	public boolean deleteFlight(int xid, String flightNum)
		...
		boolean returnVal = false;
		try{
			returnVal = rmFlights.deleteFlight(xid, flightNum);
		}
		catch(RemoteException e)
		{
	...
	public boolean addRooms(int xid, String location, int numRooms, int price) 
		...
		boolean returnVal = false;
		try{
			returnVal = rmRooms.addRooms(xid, location, numRooms, price);
		}
		catch(RemoteException e)
		{
	...
	public boolean deleteRooms(int xid, String location, int numRooms) 
		...
		boolean returnVal = false;
		try{
			returnVal = (rmRooms.deleteRooms(xid, location, numRooms));
		}
		catch(RemoteException e)
		{
		}
	...
	public boolean addCars(int xid, String location, int numCars, int price) 
		...
		boolean returnVal = false;
		try{
			returnVal =(rmCars.addCars(xid, location, numCars, price));
		}
		catch(RemoteException e)
		{
		}
	...
	public boolean deleteCars(int xid, String location, int numCars) 
		...
		boolean returnVal = false;
		try{
			returnVal= (rmCars.deleteCars(xid, location, numCars));
		}
		catch(RemoteException e)
		{
		}
	...
	public boolean newCustomer(int xid, String custName) 
		...
		boolean returnVal = false;
		try{
			returnVal = (rmCustomers.newCustomer(xid, custName));
		}
		catch(RemoteException e)
		{
		}
	...
	public boolean deleteCustomer(int xid, String custName) 
		...
		boolean returnVal = false;
		try{
			returnVal = (rmCustomers.deleteCustomer(xid, custName));
		}
		catch(RemoteException e)
		{
		}
